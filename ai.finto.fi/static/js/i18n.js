const messages = {
  ...
  sv: {
    ...
    alert_language_detection_failed: "Automatisk identifiering av textspråket misslyckades. Välj ett språk med knapparna ovan.",
    ...
    email_label: "E-post:",
    footer_info: "Finto AI är en tjänst för automatisk innehållsbeskrivning. Denna tjänst är baserad på ",
    footer_info_tool: "-verktyget.",
