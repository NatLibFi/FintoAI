...
jQuery(function() {
    ...
    $.i18n().load({
        ...
        'sv': {
            ...
            "nav-tab-file-input": "Ladd up en fil",
            ...
            "supported-file-formats": "Format som stöds: ",
            ...
            "text-box-placeholder-file-input": 'Texten från filen hämtas här. Tryck sedan på knappen "Ge förslag till ämnesord"',
            "text-box-placeholder-url-input": 'Texten från URL hämtas här. Tryck sedan på knappen "Ge förslag till ämnesord"',
            "text-box-background": 'Du kan också släppa en fil eller en URL här',
            "loading": "Laddning...",
        ...
        'fi': {
            ...
            "text-box-placeholder-text-input": 'Kopioi teksti tähän ja paina “Anna aihe-ehdotukset”-nappia',
            "text-box-placeholder-file-input": 'Teksti tiedostosta haetaan tähän. Paina sitten "Anna aihe-ehdotukset"-nappia',
            "text-box-placeholder-url-input": 'Teksti URL-osoitteesta haetaan tähän. Paina sitten “Anna aihe-ehdotukset”-nappia',
