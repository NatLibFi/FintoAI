...
jQuery(function() {
    ...
    $.i18n().load({
        ...
        'fi': {
            ...
            "text-box-placeholder": 'Kopioi teksti tähän ja paina “Anna aihe-ehdotukset”-nappia',
            "text-box-placeholder-file-input": 'Valittuasi tiedoston teksti siitä tulee tähän. Paina sitten “Anna aihe-ehdotukset”-nappia',
            // "text-box-placeholder-url-input": 'Kopioi teksti tähän ja paina “Anna aihe-ehdotukset”-nappia',
