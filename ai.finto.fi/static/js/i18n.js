...
jQuery(function() {
    ...
    $.i18n().load({
        ...
        'en': {
            ...
            "text-box-placeholder": 'You can alternatively copy text here. Then press the button "Get subject suggestions"',
            "text-box-background": 'Or you can drop a file or a URL here',
        ...
        'sv': {
            ...
            "text-box-placeholder": 'Du kan alternativt kopiera text hit. Du kan få förslag genom att trycka på knappen "Ge förslag till ämnesord"',
            "text-box-background": 'Eller du kan släppa en fil eller en URL här',
        ...
        'fi': {
            ...
            "text-box-background": 'Tai voit pudottaa tiedoston tai URL:n tähän',
