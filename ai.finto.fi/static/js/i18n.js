const messages = {
    ...
    guide_url: "???",
    info: "Finto AI ehdottaa tekstille sopivia aiheita. Palvelu perustuu Annif-työkaluun.",
    ...
    footer_info: "Finto AI on automaattisen sisällönkuvailun palvelu, joka perustuu Annifin versioon ",
    ...
    footer_info_link: "Tietoa Fintosta",
    footer_contact_link: "Yhteystiedot",
    ...
    footer_twitter_link: "Twitterissä",
  ...
  en: {
    ...
    email_label: "E-mail:",
    footer_info: "Finto AI is a service for automated subject indexing. It is powered by Annif version ",
    ...
    footer_info_link: "About Finto",
    footer_contact_link: "Contact information",
  ...
  sv: {
    ...
    guide_url: "???",
    info: "Finto AI föreslår ämnesord för text. Det är baserat på verktyget Annif.",
    ...
    alert_request_failed: "Det gick inte att extrahera text.",
    alert_request_failed_url: "Det gick inte att extrahera text. Storlek av objekt max. 6 MB. Inga omdirigeringar.",
    ...
    language_select_label: "Förslagets språk",
    ...
    copy_term_title: "Kopiera term till urklipp",
    copy_uri_title: "Kopiera URI till urklipp",
    copy_label_and_uri_title: "Kopiera term, URI och språkets kod till urklipp för Melinda/Aleph",
    term_button: "TERM",
    no_results: "Inga resultat",
    email_label: "E-post:",
    footer_info: "Finto AI är en tjänst för automatisk ämnesordsindexering, som är baserat på Annif version ",
    ...
    footer_info_link: "Information om Finto",
    footer_contact_link: "Kontaktinformation",
