const messages = {
  ...
  sv: {
    ...
    header_nav_guide: "Anvisningar",
    finto_url: "https://finto.fi/sv/",
    about_url: "https://www.kiwi.fi/x/FoDbCQ",
    feedback_url: "http://finto.fi/sv/feedback",
    guide_url: "???",
    info: "Finto AI föreslår ämnesord för text. Servicen är baserad på verktyget Annif.",
    ...
    email_label: "E-post:",
    footer_info: "Finto AI är en tjänst för automatisk innehållsbeskrivning, som baserar sig på Annif version ",
